  ...
  <div class="row">
    ...
    <?php include "./templates/sidebar.php"; ?>
      ...
      <div class="row">
      	...
      	<div class="col-2">
      		<a href="#" data-toggle="modal" data-target="#add_product_modal" class="btn btn-success btn-sm">Add Service</a>
      	</div>
      </div>
      ...
      <div class="modal-body">
        <form id="add-product-form" enctype="multipart/form-data">
        	<div class="row">
        		...
        		<div class="col-12">
        			<div class="form-group">
		        		<label>Product Keywords <small>(eg: Ads, workshop, Advertizing)</small></label>
        		...
        		<div class="col-12">
        			<button type="button" class="btn btn-success add-product">Add Service</button>
        		</div>
        	</div>
      ...
      <div class="modal-body">
        <form id="edit-product-form" enctype="multipart/form-data">
          <div class="row">
            ...
            <div class="col-12">
              <button type="button" class="btn btn-success submit-edit-product">Add Service</button>
            </div>
          </div>
